        ...
        <section id="equipe" className="py-24 bg-[#f5f5f4] border-t border-stone-200 scroll-mt-20">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    <span className="font-handwriting text-mmt-gold text-4xl block mb-2">L'Équipage</span>
                    <h2 className="font-serif text-5xl text-mmt-dark">Les Gardiens du Voyage</h2>
                </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-start">
                            <div className="w-full md:w-1/2">
                                ...
                                <div className="mt-4 text-center">
                                    ...
                                    <p className="font-serif text-[10px] uppercase tracking-widest text-mmt-gold font-bold">Fondateur & Tech-Épicurien</p>
                                </div>
                            </div>
                            <div className="w-full md:w-1/2">
                                <blockquote className="italic text-stone-600 mb-6 font-serif text-lg leading-snug">
                                    "Utiliser la technologie pour simplifier les systèmes et revenir aux fondamentaux de l'humain."
                                </blockquote>
                                <ul className="space-y-4 text-sm text-stone-600 font-light">
                                    <li className="flex gap-2">
                                        <MapPin size={14} className="text-mmt-gold shrink-0 mt-1" />
                                        <span><strong>Mougins</strong> (Full Remote)</span>
                                    </li>
                                    <li className="flex gap-2">
                                        <Coffee size={14} className="text-mmt-gold shrink-0 mt-1" />
                                        <span><strong>Expertise :</strong> Simplification & Tech.</span>
                                    </li>
                                    <li className="flex gap-2">
                                        <Globe size={14} className="text-mmt-gold shrink-0 mt-1" />
                                        <span><strong>Vision :</strong> L'Économie de la Vitalité.</span>
                                    </li>
                                </ul>
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-start">
                            <div className="w-full md:w-1/2">
                                ...
                                <div className="mt-4 text-center">
                                    ...
                                    <p className="font-serif text-[10px] uppercase tracking-widest text-mmt-gold font-bold">Head of VIP Lifestyle</p>
                                </div>
                            </div>
                            <div className="w-full md:w-1/2">
                                <blockquote className="italic text-stone-600 mb-6 font-serif text-lg leading-snug">
                                    "Transformer la promesse numérique en une expérience physique inoubliable."
                                </blockquote>
                                <ul className="space-y-4 text-sm text-stone-600 font-light">
                                    <li className="flex gap-2">
                                        <Wind size={14} className="text-mmt-gold shrink-0 mt-1" />
                                        <span><strong>L'Explorateur :</strong> Globe-trotter (Thaïlande, Écosse...)</span>
                                    </li>
                                    <li className="flex gap-2">
                                        <Sun size={14} className="text-mmt-gold shrink-0 mt-1" />
                                        <span><strong>Fighting Spirit :</strong> Champion de Karaté 2024.</span>
                                    </li>
                                    <li className="flex gap-2">
                                        <Compass size={14} className="text-mmt-gold shrink-0 mt-1" />
                                        <span><strong>Mission :</strong> Garantir l'authenticité terrain.</span>
                                    </li>
                                </ul>
